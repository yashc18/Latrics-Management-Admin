...
import { SubmissionStatistics as StatsType } from "@/lib/firebase-types";
...
export function SubmissionStatistics({ statistics, loading }: SubmissionStatisticsProps) {
  if (loading) {
    return (
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{statistics.totalContributors}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{statistics.recentActivityCount}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{Object.keys(statistics.submissionsByTemplate).length}</div>
